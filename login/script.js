...
const account1 = {
  ...
  movementsDates: [
    ...
    '2025-12-22T17:01:17.194Z',
    '2025-12-23T23:36:17.929Z',
    '2025-12-24T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
const calcDisplayBalance = function (acct) {
  acct.balance = acct.movements.reduce((accu, mov) => accu + mov, 0);
...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    // When it is 0 seconds, stop timer and log out user
    if (time === 0) {
      clearInterval(timer);
      // Clear UI and message
